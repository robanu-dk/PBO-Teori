...
class Vektor :
    ...
    def __init__(self, v= None) :
        if(v!= None) :
            if(type(v) == list) : self.__v = v
            else :
                self.__v = []
                for i in range(v) :
                    self.__v.append(randint(0,100))
        else :
            self.__v = []
...
print(">>> op.tampilVektor(v= v1)")
op.tampilVektor(v= v1)

print(">>> v2 = Vektor(v= 1)")
v2 = Vektor(v= 5)

print(">>> op.tampilVektor(v= v2)")
op.tampilVektor(v= v2)

print(">>> v3 = Vektor(v= [4, 5, 6])")
v3 = Vektor(v= [4, 5, 6])

print(">>> op.tampilVektor(v= v3)")
op.tampilVektor(v= v3)

print(">>> v4 = Vektor(v= [1, 2, 3, 4, 5, 6])")
v4 = Vektor(v= [1, 2, 3, 4, 5, 6])

print(">>> op.tampilVektor(v= v4)")
op.tampilVektor(v= v4)
